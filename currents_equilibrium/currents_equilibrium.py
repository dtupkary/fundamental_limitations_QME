...
data=np.column_stack((epsilonvals,redfield_current,locallindblad_current,universal_current_site1,universal_current_site2))
np.savetxt('epsilonscaling_currents.txt',data,header=string+'Epsilon || REDFIELD ||  LLE || ULE SITE 1 || ULE SITE 2')
