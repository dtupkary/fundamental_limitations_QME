...
data=np.loadtxt('epsilonscaling_currents.txt')
epsilonvals=data[:,0]
...
ax1.text(1e-3,1.7e-5,string,fontsize=10,bbox=dict(facecolor='none', edgecolor='black', pad=2.0))
...
plt.savefig('current_equilibrium.png',dpi=600,bbox_inches='tight')
