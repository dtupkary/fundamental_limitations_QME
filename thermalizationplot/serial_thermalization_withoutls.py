...
Lamb shift IS NOT included in this!
@author: Devashish
"""
...
for g in gvals:
    ...
    print('Lambshift is ignored for ULE ...')
    lambshift=0
...
string="N={},w01={},w02={},w03={}, tb={},epsilon={},gamma1={},gamma2={}\n delta={}, mu1={},mu2={},beta1={},beta2={} ".format(N,w0list[0],w0list[1],w0list[2],tb,epsilon,gamma1,gamma2,delta,mu1,mu2,beta1,beta2)
...
np.savetxt("N={},10delta={}_thermalization_withoutls.txt".format(N,10*delta),data,header=header)
