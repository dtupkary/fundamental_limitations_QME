...
Computes and plots magnetization profile for all 4 approachs in noneq.
...
string="N={},w01={},w02={},w03={},g={},tb={},epsilon={},gamma1={},gamma2={}, delta={}, \n mu1={},mu2={},beta1={},beta2={}".format(N,w0list[0],w0list[1],w0list[2],g,tb,epsilon,gamma1,gamma2,delta,mu1,mu2,beta1,beta2)
...
data=np.column_stack((zpositions,redfield_profile,realredfield_profile,lindblad_profile,universal_profile))
np.savetxt('N={},10delta={},profile.txt'.format(N,int(10*delta),data,header=string+"\n magnetization profile.: POSLIST ||| REDFIELD ||| REALREDFIELD ||| LINDBLAD ||| UNIVERSAL")
