...
data=np.loadtxt("N=3,10delta=10,profile_ex1.txt")
...
# ax11.text(1.75,-0.95,string,fontsize=9)
...
ax11.text(1.75,-0.94,string,fontsize=10,bbox=dict(facecolor='none', edgecolor='black', pad=2.0))
...
plt.ticklabel_format(style='sci', axis='y', scilimits=(0,0))
fig.tight_layout()
plt.savefig('magplot_noneq',dpi=500,bbox_inches='tight')
